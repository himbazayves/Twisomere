...
if(isset($_GET["sign"]))
{
    ...
    if($sign=="out")
    {
        unset($_SESSION["parent_twis_data_2020"]);
...
if(isset($_SESSION['parent_twis_data_2020']) == false){
    header("Location:../login.php");
}else{
    ?>
                                ...
                                $sql5="SELECT * from parent where parent_username='$_SESSION[parent_twis_data_2020]'";
                                ...
                                $p_id=$row5['parent_id'];
                                $sub_id=$row5['sub_id'];
                                $p_username=$row5['parent_username'];
                                $p_Fname=$row5['parent_Fname'];
                                $p_Lname=$row5['parent_Lname'];
                                $p_mail=$row5['parent_email'];
                                $p_tel=$row5['parent_tel'];
                                $p_pass=$row5['parent_password'];
                                $p_status=$row5['parent_status'];
                                $p_profile=$row5['parent_profile'];
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                                        ...
                                                        ?>
                                           <img src="parent_profile/<?php echo $fileName ?>" alt="<?php echo $p_username ?>" />
                                        </div>
                                        <div class="content">
                                            <a class="js-acc-btn" href="#"><?php echo $p_username ?></a></a>
                                        </div>
                                        <div class="account-dropdown js-dropdown">
                                            <div class="info clearfix">
                                                ...
                                                <div class="content">
                                                    <h5 class="name">
                                                        <a href="#"><?php echo $p_username ?></a></a>
                                                    </h5>
                                                    <span class="email"><?php echo $p_mail ?> </a></span>
                                                </div>
                                            </div>
...
<body class="animsition">
            ...
            <nav class="navbar-mobile">
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-users"></i>Children</a>
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="index.php?add_child">New Children</a>
                                </li>
                                <li>
                                    <a href="index.php?view_childrens">Manage Children</a>
                                </li>
                            </ul>
                        </li> 
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="index.php">
                                <i class="fas fa-tasks"></i>Children Progress</a>
                        </li>                
            ...
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list"> 
                        ...
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-inbox"></i>Subscription</a>
                                            ...
                                            <?php
                                                if (empty($profile)) {
                                                    ...
                                                    <div class="notifi__item">
                                                        ...
                                                        <div class="content">
                                                            <p>You got a Profile notification</p>
                                                            <span class="date">Update your profile</span>
                                                        </div>
                                                    </div>
                                                    <?php
                                                } else {
    ...
    if(isset($_GET['home']))
        ...
        {           
         ...
         elseif(isset($_GET['view_childrens']))
        {           
            include("view_childrens.php");
        }
...
<script>
                    <?php
                        $sql1="SELECT COUNT(*) AS male_student FROM student where parent_id='$p_id' AND student_gender='male' ";
                    ...
                    <?php
                        $sql2="SELECT COUNT(*) AS female_student FROM student where parent_id='$p_id' AND student_gender='female'  ";
