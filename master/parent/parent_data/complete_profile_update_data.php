...
if(empty($_FILES['profile']['name'])||empty($p_tel)||empty($p_Fname)||empty($p_id)||empty($p_pass)) {
...
else
{
    ...
    if(move_uploaded_file($file_location, "../parent_profile/" . $new_file_name)){
        ...
        $sql="UPDATE parent set parent_Fname='$p_Fname',parent_Lname='$p_Lname',parent_email='$p_mail',parent_tel='$p_tel',parent_password='$p_pass',parent_profile='$new_file_name' where parent_id='$p_id'";
