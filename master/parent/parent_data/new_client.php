...
$query=$conn->query("SELECT parent_username from parent where parent_username='$username'");
if($query->num_rows == 1){
?>
...
<?php
                    ...
                    $sql="INSERT INTO parent(  `parent_username`, `parent_email`, `parent_password`,`parent_status`)
                    VALUE('$username','$email','$password','0')";

                    if ($conn->query($sql)==TRUE) {
                        ?>
                        <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                            <span class="badge badge-pill badge-success">Done</span>
                                You have Succefully created Parent Account.
