                <div class="container-fluid">
                     ...
                     <br>
                      ...
                      <div class="row" id="loader_general_admin1">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Child List</h3>
                                    ...
                                    <table class="table table-data2" id="Table1">
                                        <thead>
                                            <tr>
                                                ...
                                                $sql1="SELECT * from student WHERE parent_id='$p_id' ";
                                        ...
                                        <tbody>
                                            <tr class="tr-shadow">
                                                ...
                                                <td><?php echo $a ?></td>
                                                <td>
                                                   <img style="height:60px;width: 120px;float: left;" src="../children/student_profiles/<?php echo $fileName ?>" alt="<?php echo $p_fn ?>" />
                                                </td>
