                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2"><b>New Child</b> Details</h3>
                                        </div>
                                        <div id="profile_complete_message">
                                        </div>
                                        <hr>
                                        <form action="#/" onsubmit="parent_new_student();return false;" method="post">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        <img class="align-self-center  mr-3" src="parent_profile/avatar.png" alt="<?php echo $t_username ?>" id="blah" alt="Card image cap" width="280px" height="230px">
                                                        <br><br>
                                                        <input type='file' id="profile" name="profile" onchange="readURL(this);" />
                                                    </div>
                                                    <input id="school" name="school" type="text" class="form-control cc-cvc" value="<?php echo $p_id ?>" style="display: none;" >
                                                </div>
                                                <div class="col-lg-8">

                                                    <label for="x_card_code" class="control-label mb-1">Children Username</label>
                                                    <div class="input-group">
                                                        <input id="s_username" name="s_username" type="text" class="form-control cc-cvc"  data-val="true">
                                                    </div>

                                                    <label for="x_card_code" class="control-label mb-1">Children Class</label>
                                                    <div class="input-group">
                                                        <select id="s_class" name="s_class" class="form-control" aria-required="true">
                                                            <option value="0">-- Choose Child Class ---</option>
                                            ...
                                            <div>
                                                <button id="payment-button" type="submit" class="btn btn-lg btn-info btn-block">
                                                    ...
                                                    <span id="payment-button-amount">Save New Children</span>
