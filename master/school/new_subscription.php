                                        ...
                                        ?>
                                            <div style="width: 100%;padding: 30px;">
                                                <div class="sufee-alert alert with-close alert-info alert-dismissible fade show">
                                                    ...
                                                    Dear <?php echo $s_username; ?> , You Still Have Active Subscription , Unless You Want To Create Another New One.
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <form action="#/" onsubmit="new_school_subscribe();return false;"  method="post" novalidate="novalidate">
                                            ...
                                            <div class="form-group">
                                                <label for="cc-payment" class="control-label mb-1">School Students</label>

                                                            <?php

                                                                $sql2="SELECT COUNT(*) AS Total_students from student WHERE school_id='$s_id' ";
                                                ...
                                                <label for="cc-payment" class="form-control"><?php echo $t_students ?> Students</label>
                                                ...
                                                <input style="display: none;" id="school" name="school" type="number" value="<?php echo $s_id ?>" class="form-control" aria-required="true"  aria-invalid="false" id="student" >
