...
<?php
                    ...
                    $sql="INSERT INTO subscription( `sub_school`,`plan_name`, `sub_start_date`, `sub_end_time`,`sub_student_number`,`sub_total_price`,`sub_status`)
                    VALUE('$school','$plan_name','$starting_date','$end_time','$student','$total_amount','processed')";

                    $sql1=" UPDATE school SET sub_id=1 WHERE school_id='$school'";
                    if ($conn->query($sql)&&$conn->query($sql1)==TRUE) {
                        ?>
                    <div style="width: 100%;float: left;padding: 10px;">    
                        <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                            <span class="badge badge-pill badge-success">Done</span>
                                You have Succefully Created Your School New Subscription.
