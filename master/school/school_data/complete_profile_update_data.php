...
if(empty($_FILES['profile']['name'])||empty($s_tel)||empty($s_username)||empty($s_id)||empty($s_pass)) {
...
else
{
    ...
    if(move_uploaded_file($file_location, "../profile_data/" . $new_file_name)){
        ...
        $sql="UPDATE school set school_name='$s_username',school_email='$s_mail',school_tel='$s_tel',school_password='$s_pass',school_profile='$new_file_name' where school_id='$s_id'";
