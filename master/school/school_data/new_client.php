...
$query=$conn->query("SELECT school_name from school where school_name='$username'");
if($query->num_rows == 1){
?>
...
<?php
                    ...
                    $sql="INSERT INTO school(  `school_name`, `school_email`, `school_password`,`school_status`)
                    ...
                    if ($conn->query($sql)==TRUE) {
                        ...
                        <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                            <span class="badge badge-pill badge-success">Done</span>
                                You have Succefully created School account.
