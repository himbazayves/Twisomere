                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive table-responsive-data">                                
                                    <a href="index.php?view_book">
                                        <button  class=" title-5 m-b-35 au-btn au-btn-icon au-btn--blue au-btn--small">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <embed src="../master/books/<?php echo $b_name ?>/<?php echo $b_attach ?>#toolbar=0&navpanes=0&scrollbar=0" type="application/pdf" width="100%" height="600px" />
                                        </div>
                                            <br>
                                    </div>
                                </div>
                                ...
                                <center><a  href="quiz?b_id=<?php echo $b_id;?>" href="quiz"class="btn btn-success">
        <i class="fa fa-magic"></i>&nbsp; Wasoje? kora igerageza. </a></center>
