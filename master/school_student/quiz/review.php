        ...
        <aside class="menu-sidebar2">
            ...
            <div class="menu-sidebar2__content js-scrollbar1">
                <div class="account2">
                    ...
                    <a href="?sign=out" id="logout">Sohoka</a>
                </div>
                <nav class="navbar-sidebar2">
                    <ul class="list-unstyled navbar__list">
                        <li class="active has-sub">
                            <a class="js-arrow" href="index.php">
                                <i class="fas fa-tachometer-alt"></i>Conte yanjye
                            </a>
                        </li>
                        <li>
                            <a href="index.php?view_book">
                                <i class="fas fa-book"></i>Ibitabo</a>
                            
                        </li>
                        <li class="has-sub">
                            <a class="js-arrow" href="#">
                                <i class="fas fa-file"></i>Amageragezwa
                                <span class="arrow">
                ...
                <div class="menu-sidebar2__content js-scrollbar2">
                    ...
                    <nav class="navbar-sidebar2">
                        <ul class="list-unstyled navbar__list">
                            <li>
                                <a class="js-arrow" href="index.php">
                                    <i class="fas fa-tachometer-alt"></i>Ahabanza
                                </a>
                            </li>
                            <li>
                                <a href="index.php?view_book">
