...
else
{
    ...
    if (!file_exists("../books/".$b_name)) {
        ...
        mkdir('../books/'.$b_name, 0777, true); // folder creation 
        ...
        // second pic
        if (($_FILES["b_attach"]["type"] == "image/gif") || ($_FILES["b_attach"]["type"] == "image/jpeg") || ($_FILES["b_attach"]["type"] == "image/pjpeg") || ($_FILES["b_attach"]["type"] == "image/bmp") || ($_FILES["b_attach"]["type"] == "image/png") && ($_FILES["b_attach"]["size"] < 20000000)) 
        {
        ...
        $sql="UPDATE book SET book_author='$author',book_name='$b_name',book_summary='$b_summary',book_cover='$filename1',book_attachment='$b_attach',level_id='b_level' WHERE book_id='b_id' ";
        if ($conn->query($sql)===TRUE)
        {
            ?>
            <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                <span class="badge badge-pill badge-success">Done</span>
                    You have Succefully Update <?php echo "$b_name"; ?> Book Details.
                <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="" onclick="location.reload();">
                <span aria-hidden="true">&times;</span>
                </button>
                <br>
