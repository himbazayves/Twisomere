...
if(empty($_FILES['profile']['name'])||empty($m_tel)||empty($m_username)||empty($m_id)||empty($m_Fname)||empty($m_Lname)||empty($m_pass)) {
...
else
{
    ...
    if(move_uploaded_file($file_location, "../profile_data/" . $new_file_name)){
                        
        $sql="UPDATE admin set admin_username='$m_username',admin_Fname='$m_Fname',admin_Lname='$m_Lname',admin_email='$m_mail',admin_tel='$m_tel',admin_password='$m_pass',admin_profile='$new_file_name' where admin_id='$m_id'";
