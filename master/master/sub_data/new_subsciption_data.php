...
$query=$conn->query("SELECT plan_name from plan where plan_name='$sub_name'");
if($query->num_rows == 1){
?>
<div style="width: 100%;float: left;padding: 10px;">
    <div class="sufee-alert alert with-close alert-danger alert-dismissible fade show" >
        <span class="badge badge-pill badge-danger">Error</span>
            Sorry the <strong><?php echo "$sub_name"; ?></strong> is Already Registered.
...
$sql="INSERT INTO plan( `plan_name`, `plan_price`, `plan_description`)
                    VALUE('$sub_name','$sub_amount','$sub_descr')";
                    if ($conn->query($sql)==TRUE) {
                        ?>
                    <div style="width: 100%;float: left;padding: 10px;">    
                        <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                            <span class="badge badge-pill badge-success">Done</span>
                                You have Succefully created New Plan.
