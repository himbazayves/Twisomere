...
else
{
    ...
    if(move_uploaded_file($file_location, "../teacher_profile/" . $new_file_name)){
        ...
        $sql="UPDATE teacher set teacher_username='$username',teacher_email='$email',teacher_tel='$tel',teacher_password='$password',teacher_profile='$new_file_name',teacher_Fname='$f_name',teacher_Lname='$l_name',teacher_status='1' where teacher_id='$t_id'";
