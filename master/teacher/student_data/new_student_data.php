...
<?php
    ...
    else
    {
        ...
        if(move_uploaded_file($file_location, "../../school_student/student_profiles/" . $new_file_name)){
            ...
            $sql="INSERT INTO student( `school_id`, `student_Fname`, `student_Lname`,`student_gender`,`student_username`,`student_password`,`level_id`,`parent_id`,`student_profile`)
                ...
                VALUE('$school','$s_Fname','$s_Lname','$s_sex','$s_username','$s_pass','$s_class','0','$new_file_name')";
